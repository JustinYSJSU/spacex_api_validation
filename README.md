...
## Folder Structure
- /response_code_test_data -> Contains .yaml file which stores 'id' values for various SpaceX entities. These 'id' values are used in response code testing to avoid hard coding values and enables a data-driven approach for maintainability.
