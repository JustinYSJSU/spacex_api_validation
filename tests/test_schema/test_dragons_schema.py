"""
test_dragons_schema.py

This file contains automated tests for the SpaceX Dragon API endpoints.
It validates:
...
- schema_test_data/all_dragons.yaml -> contains valid schema for a sample set of 'all dragons' data
- schema_test_data/single_dragon.yaml -> contains valid schema for a 'single' dragon data
...
class TestSchemaDragons:
    ...
    def verify_schema_dragon(self, valid_schema, url):
